...
export const problem_2_rational_equation = async (event) => {
	...
	katex.render("3x+1-1-x-x+1=0", document.getElementById("problem-2-rational-solution-equation-2"), { throwOnError: false });

	katex.render("x+1=0", document.getElementById("problem-2-rational-solution-equation-2"), { throwOnError: false });

	// final
	katex.render("x=-1", document.getElementById("problem-2-rational-solution-equation-2"), { throwOnError: false });
};