export const problem_1_rational_equation = async (event) => {
	...
	await katex.render("\\frac{1}{x-1}+\\frac{1}{x+1}=\\frac{4x+2}{x^2-1-1}", document.getElementById("problem-1-rational-equations"), { throwOnError: false})
...
export const problem_2_rational_equation = async (event) => {
	event.preventDefault();
	// state = false
 	...
 	katex.render("1-\\frac{1-x}{3x+1}-\\frac{x^2+1}{3x^2-1-2x-1}=0", document.getElementById("problem-2-rational-equations"), { throwOnError: false });
	...
	katex.render("(1-\\frac{1-x}{3x+1}-\\frac{x+1}{3x+1}=0)3x+1", document.getElementById("problem-2-rational-solution-equation-1"), { throwOnError: false });
	
	katex.render("(1(3x+1)-\\frac{1-x\\cancel{(3x+1)}}{\\cancel{3x+1}}-\\frac{x+1\\cancel{(3x+1)}}{\\cancel{3x+1}}=0)3x+1", document.getElementById("problem-2-rational-solution-equation-2"), { throwOnError: false });

	katex.render("3x+1-1-x-x+1=0", document.getElementById("problem-2-rational-solution-equation-3"), { throwOnError: false });

	katex.render("x+1=0", document.getElementById("problem-2-rational-solution-equation-4"), { throwOnError: false });

	// final
	katex.render("x=-1", document.getElementById("problem-2-rational-solution-equation-5"), { throwOnError: false });
};